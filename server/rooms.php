...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<a href='editrooms.php?quarto=" . $row['quarto'] . "' class='btn btn-primary'>Editar Quarto</a>";

    echo "<a href='deleteroom.php?quarto=" . $row['quarto'] . "' class='btn btn-danger'>Excluir Quarto</a>";
